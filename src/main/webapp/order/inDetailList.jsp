...
<%
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + path + "/";
		Logger.getRootLogger().error(basePath);
%>
				...
				<table width="100%">
					<tr align="center">
						<td width="50%" algin="right">
							<a href="inList.jsp" style="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(.images/btn_bg.jpg)">
								返&nbsp;&nbsp;回
							</a>
						</td>
					</tr>
