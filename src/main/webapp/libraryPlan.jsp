...
<div class="allBlock">
	...
	<img src="img/door.png" alt="" class="door">
	<ul class="block-3 allblock">
		...
		<li onclick="gotoCabinet('P39','P40','A')" class="pai"><div><span>39-40排</span></div></li>
		<li  onclick="gotoCabinet('P37','P38','A')" class="pai"><div><span>37-38排</span></div><p>标准件</p><p>球阀</p><p>水暖管件</p></li>
		<li onclick="gotoCabinet('P27','P36','A')" class="pai"><div><span>27-36排</span></div><p>电器配件</p><p>压力表</p><p>轴承</p></li>
		<li onclick="gotoCabinet('P21','P26','A')" class="pai"><div><span>21-26排</span></div><p>接头</p><p>手动换向阀</p></li>
		<li onclick="gotoCabinet('P17','P20','A')" class="pai"><div><span>17-20排</span></div><p>多路阀接头</p></li>
		<li onclick="gotoCabinet('P09','P16','A')" class="pai"><div><span>9-16排</span></div><p>气动元件</p><p>滤油器</p><p>齿轮泵</p><p>组合垫</p></li>
		<li onclick="gotoCabinet('P01','P08','A')" class="pai"><div><span>1-8排</span></div><p>费斯托接头</p><p>快速接头力士乐阀</p></li>
