...
<div class="col-md-4 col-sm-4 col-ms-4" >
    ...
    <div id=storage onclick="location.href='libraryPlan.jsp'" class=menu_box align="center">
...
<div id=query onclick="$('#querys').modal('show')" class=menu_box>
  ...
  <div class="modal-dialog sub_menu" role="document"  id=dialog >
    ...
    <div class=sub style="background-color: #2ba8ff;cursor: hand" onclick="location.href='report/getLibAge?page=libagel&fstockid=1'">
        <img alt="" src="assets/pages/img/menu/sage.png" width="40%" height="40%" style="margin-top: 15%;"/>
     <div>   无动态</div>
        </div>
    </div>
        <div class="col-md-3 col-sm-3 col-xs-3">
            <div class=sub style="background-color: #fd672b;cursor: hand" onclick="window.location.href='report/getFrenqucy?page=frenqucyl&fstockid=1'">
        ...
        <div class="col-md-3 col-sm-3 col-xs-3">
            <div class=sub style="background-color: #6fcc41;cursor: hand" onclick="window.location.href='report/getFrenqucy?page=frenqucya&fstockid=1'">
                <img alt="" src="assets/pages/img/menu/frenqucy.png" width="40%" height="40%" style="margin-top: 15%;"/>
                <div>   长期缺货</div>
            </div>
        </div>
        ...
        <div class="col-md-3 col-sm-3 col-xs-3">
            <div class=sub style="background-color: #ea5e56;cursor: hand" onclick="window.location.href='report/getQualified?page=qratel&fstockid=1'">
...
<!-- 查询子菜单 -->
  ...
  <div class="modal-dialog sub_menu" role="document"  id=dialog >
    ...
    <div class=row>
    <div class="col-md-3 col-sm-3 col-xs-3">
    <div class=sub  style="background-color: #E047B3;cursor: hand" onclick="window.location.href='report/getmgList?fstockid=1'">
        <img alt="" src="assets/pages/img/page/xn.png" width="40%" height="40%" style="margin-top: 15%;"/>
     <div>  物料-货位</div>
        </div>
    </div>
        <div class="col-md-3 col-sm-3 col-xs-3">
            <div class=sub style="background-color: #2ba8ff;cursor: hand" onclick="location.href='report/getInventoryBalance?flag=1&fstockid=1'">
                <img alt="" src="assets/pages/img/menu/kc.png" width="40%" height="40%" style="margin-top: 15%;"/>
                <div>   库存台账</div>
            </div>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-3">
            <div class=sub style="background-color: #fd672b;cursor: hand" onclick="window.location.href='report/getInventoryBalance_date?flag=1&fstockid=1'">
                <img alt="" src="assets/pages/img/menu/kc.png" width="40%" height="40%" style="margin-top: 15%;"/>
                <div>   物料收发<br>日报表</div>
            </div>
        </div>
        ...
        <div class="col-md-3 col-sm-3 col-xs-3">
            <div class=sub style="background-color: #6fcc41;cursor: hand" onclick="window.location.href='report/getInventorySummary?flag=1&fstockid=1'">
                <img alt="" src="assets/pages/img/menu/kc.png" width="40%" height="40%" style="margin-top: 15%;"/>
                <div>   物料收发<br>汇总表</div>
            </div>
        </div>
    <%--  <div class="col-md-6 col-sm-6 col-xs-6">
     ...
     <div>   容量余量</div>
          ...
          <div class=row>
              <div class="col-md-3 col-sm-3 col-xs-3">
                  <div class=sub  style="background-color: #E047B3;cursor: hand" onclick="window.location.href='report/getICstockSummary?flag=1&fstockid=1'">
                      <img alt="" src="assets/pages/img/menu/kc.png" width="40%" height="40%" style="margin-top: 15%;"/>
                      <div>  异常收发<br>汇总表</div>
                  </div>
              </div>
              <div class="col-md-3 col-sm-3 col-xs-3">
                  <div class=sub  style="background-color: #2ba8ff;cursor: hand" onclick="window.location.href='report/getGuaranteePeriod?flag=1&fstockid=1'">
                      <img alt="" src="assets/pages/img/menu/kc.png" width="40%" height="40%" style="margin-top: 15%;"/>
                      <div>  保质期清单</div>
                  </div>
              </div>
