...
$(function(){
	function distance(){
		...
		$('.listLi3').css('width',(mainBloWid)/10).css('marginLeft',(mainBloWid*0.2)/17.3);
		...
		$('.block-9').css('width', mainBloWid/1.5).css('height', (mainBloHei-warHei)/2-10).css('marginLeft', liHeight/2.5);
		$('.listLi-9-li1').css('lineHeight',liHeight+'px');
		$('.listLi-9-li2').css('width', mainBloWid/6.7).css('lineHeight',liHeight+'px');
		//---2018-3-19 xingli---
	};
	//加载页面及调整窗口时调用计算布局
	distance();
