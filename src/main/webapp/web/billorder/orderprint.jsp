    ...
    <tr>
        ...
        <td>
            <table style="width: 100%">
                <tr>
                    <th>单据编号</th><td>${billorder.fnumber}</td>
                    <th>业务日期</th><td>
                    <fmt:formatDate value="${billorder.fbizdate}" pattern="yyyy-MM-dd"></fmt:formatDate>
                </td>
                    <th>供应商</th><td>${billorder.supplier.suppliername}</td>
                </tr>
            </table>
        </td>
    </tr>
