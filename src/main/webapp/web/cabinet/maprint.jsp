...
<div class="container">
 <%--   <div id="codes" align="center">
    ...
    <div  align="center" id="image">
        ...
        <%--${mplist[0]}--%>
       <c:forEach items="${cplist}" var="map" varStatus="st">
          <%-- <div id="code${st.index}" class="code"></div>--%>
           <%--<div class="row">
               <div class="col-md-4 col-sm-4 col-xs-4" style="font-size: 10px;font-weight: bold">${map[0].fnumber}</div>
               <div class="col-md-4 col-sm-4 col-xs-4" style="font-size: 10px;font-weight: bold">${map[1].fnumber}</div>
               <div class="col-md-4 col-sm-4 col-xs-4" style="font-size: 10px;font-weight: bold">${map[2].fnumber}</div>
           </div>--%>

           <div style="font-size: 80px;font-weight: bold">${map.cabprint.fnumber}</div>
           &nbsp;&nbsp;
           <div style="font-size: 40px;font-weight: bold">(${map.sclist[0].fnumber},${map.sclist[1].fnumber},${map.sclist[2].fnumber})</div>
