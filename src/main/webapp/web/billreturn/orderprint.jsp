...
<table align="center" style="width: 90%" id="billprint">
    <tr><th colspan="2">  <h3>退换货</h3></th></tr>
    <tr>
        <td> <img id="image" src=""/>
        ...
        <td>
            <table style="width: 100%">
                <tr>
                    <th>单据编号</th><td>${billreturn.fnumber}</td>
                    <th>业务日期</th><td>
                    <fmt:formatDate value="${billreturn.fbizdate}" pattern="yyyy-MM-dd"></fmt:formatDate>
                </td>
                    <th>供应商</th><td>${billreturn.supplier.suppliername}</td>
                </tr>
            </table>
        </td>
    </tr>
