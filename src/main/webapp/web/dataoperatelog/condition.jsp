...
<!-- <button class=btn data-toggle="modal" data-target="#operateLog">show</button> -->
      <div class="modal fade" id="dataoperatelog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
         <h4 class="modal-title" id="myModalLabel">资料操作记录条件过滤</h4>
      </div>
    ...
    <input type="date" class="form-control" id="edate" name="edate" placeholder="结束时间" value=${model.edate }>
           ...
           <div class="form-group">
               ...
               <div class="col-md-8 col-sm-8 col-xs-8">
                   <div class=row>
                       <div class="col-md-10 col-sm-10 col-xs-10">
                           <div class="input-group">
                               <input  type="text" readonly onfocus="clearBasics('fdataseatid')"  class="form-control" id="dataseat" name="fdataseat"  placeholder="" value=${model.fdataseat}>
      ...
      <button class="btn btn-primary btn-sm" onclick="querySubmit('dataoperatelog/getList','opform','dataoperatelog')"> <span class="glyphicon  glyphicon-search" aria-hidden="true"></span> 查询</button>
      </div>
    </div>
  </div>
</div>
