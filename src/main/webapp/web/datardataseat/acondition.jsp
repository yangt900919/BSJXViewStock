...
<html>
  ...
  <body>
    <div class="modal fade" id="amaterialrgoodseat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
       <button type="button" class="btn btn-primary btn-sm" onclick="querySubmit('materialrgoodseat/getaList','igform','amaterialrgoodseat')">
