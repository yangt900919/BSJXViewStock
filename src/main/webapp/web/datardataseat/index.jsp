  ...
  <div class="row">
      <div class="col-md-9 col-sm-9 col-xs-9" ></div>
       <div class="col-md-3 col-sm-3 col-xs-3" >
             ...
             <div class="buttongroups">  <a class="btn btn-info  btn-sm"  onclick="filter('datardataseat')" href="javascript:;">
        <span class="glyphicon   glyphicon-filter" aria-hidden="true"></span>过滤</a>
           </div>
           <div class="buttongroups"> <a class="btn btn-danger  btn-sm"  href="javascript:;" onclick="DeleteBatch('datardataseat')">
               <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
               删除</a>
           </div>
           <div class="buttongroups" >  <a class="btn btn-primary btn-sm"  href="datardataseat/create">
...
<%--  <th >规格型号</th>--%>
  ...
  <tbody>
  <c:forEach items="${datardataseatlist }" var="map">
  <tr>
  <td>
...
<%--  <td class=wrap>${map.material.FModel }</td>--%>
  ...
  <td>
   ...
   <button class="btn btn-success btn-xs" onclick="Edit('datardataseat',${map.fid})">
        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 编辑</button>

     <%--   <c:if test="${mags_delete=='mags_delete' }">--%>
      <button class="btn btn-danger btn-xs" id="delete" onclick="Delete('datardataseat',${map.fid})">
