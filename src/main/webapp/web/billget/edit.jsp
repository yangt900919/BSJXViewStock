  ...
  <head>
	...
	<jsp:include page="../shared/resource.jsp"></jsp:include>
      ...
      <script type="text/javascript">
          index=${billget.billgetentries.size()}
      </script>
  </head>
   ...
   <c:if test="${billget.fid>0 }">  <input type="hidden" name=fid value=${billget.fid }></c:if>
               ...
               <div class="form-group">
                   ...
                   <div class="col-md-9 col-sm-9 col-xs-9">
                       <div class=row>
                               ...
                               <select ${readonly} class="form-control" id=fbiztype name=fbiztype>
                                   <option value=""></option>
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-9">
                         <div class=row>
                             ...
                             <div class="input-group">
                                 <input ${readonly} type="text"  onfocus="clearBasics('fsendstockid')"  class="form-control" id="stock" name="stockname"  placeholder="" value=${billget.stock.stockname}>
                                 <input type="hidden" class="form-control" id="fsendstockid" name=fsendstockid  placeholder="" value=${billget.fsendstockid}>
                                 <span class="input-group-btn">
           <button class="btn btn-primary" ${disabled} type="button" onclick="showBasics('stock','fsendstockid','stock')">&nbsp;<span class="glyphicon glyphicon-search form-control-feedback" aria-hidden="true" ></span>&nbsp;</button>
      </span>
                             </div>
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-9">
                         <div class=row>
                             ...
                             <div class="input-group">
                                 ...
                                 <span class="input-group-btn">
           <button class="btn btn-primary" ${disabled} type="button" onclick="showBasics('user','fgeterid','getuser')">&nbsp;<span class="glyphicon glyphicon-search form-control-feedback" aria-hidden="true" ></span>&nbsp;</button>
      </span>
                             </div>
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-9">
                         <div class=row>
                             ...
                             <div class="input-group">
                                 ...
                                 <span class="input-group-btn">
           <button class="btn btn-primary" ${disabled} type="button" onclick="showBasics('user','fsenderid','senduser')">&nbsp;<span class="glyphicon glyphicon-search form-control-feedback" aria-hidden="true" ></span>&nbsp;</button>
      </span>
                             </div>
       ...
       <div class="row">
           <div class="row">
               ...
               <div class="col-md-4 col-sm-4 col-xs-4">
                   <a class="btn btn-primary btn-xs " href="javaScript:void(0)" onclick="addEntry('get')">
        ...
        <c:forEach items="${billget.billgetentries}" var="map" varStatus="st">
         ...
         <button class="btn btn-primary" ${disabled} type="button" onclick="getmaterial('material','fmaterialid${st.index}','material${st.index}','materialname${st.index}','','materialunit${st.index}')">&nbsp;<span class="glyphicon glyphicon-search form-control-feedback" aria-hidden="true" ></span>&nbsp;</button>
                ...
                <td>
                    <input ${readonly} type="number" class="form-control bill_input" id="fapplyqty${st.index}" name="billgetentries[${st.index}].fapplyqty"  value="${map.fapplyqty}" >
                </td>
                <td>
                    <input ${readonly}  type="number" class="form-control bill_input" id="frealqty${st.index}" name="billgetentries[${st.index}].frealqty"  value="${map.frealqty}" >
                </td>
               <%-- <td>
                    <input readonly type="number" class="form-control bill_input" id="finventory${st.index}" name="billgetentries[${st.index}].finventory"  value="${map.finventory}" >
                </td>--%>
                <td>
                    <div class="input-group">
                        <input ${readonly} type="text"  onfocus="clearBasics('fsendstockid${st.index}')"  class="form-control bill_input_b" id="stock${st.index}" name="billgetentries[${st.index}].estockname"  placeholder="" value="${map.estock.stockname}">
                        <input  type="hidden" class="form-control" id="fsendstockid${st.index}" name=billgetentries[${st.index}].fsendstockid  placeholder="" value="${map.fsendstockid}">
                        <span class="input-group-btn">
         <button class="btn btn-primary" ${disabled} type="button" onclick="showBasics('stock','fsendstockid${st.index}','stock${st.index}')">&nbsp;<span class="glyphicon glyphicon-search form-control-feedback" aria-hidden="true" ></span>&nbsp;</button>
    </span>
                    </div>
                </td>
                <td>
                    <textarea rows="1" cols="10" class="form-control bill_input" id="fnote${st.index}" name="billgetentries[${st.index}].fnote" placeholder="" >${map.fnote}</textarea>
                </td>
            </tr>
        </c:forEach>
