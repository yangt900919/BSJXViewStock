  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
           ...
           <div class="form-group">
               ...
               <div class="col-md-8 col-sm-8 col-xs-8">
                   <div class=row>
                       <div class="col-md-10 col-sm-10 col-xs-10">
                           <div class="input-group">
                               <input  type="text"  onfocus="clearBasics('fscabinetid')"  class="form-control" id="scabinet" name="stockname"  placeholder="" value=${model.scabinet.fname}>
      ...
      <div class="modal-footer">
       <button type="button" class="btn btn-primary " onclick="querySubmit('materialrgoodseat/getList','igform','materialrgoodseat')">
