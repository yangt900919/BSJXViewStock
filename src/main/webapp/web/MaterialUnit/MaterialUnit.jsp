...
<script type="text/javascript">
    function showMsg(msg, fid) {
        ...
        //alert(msg);
        if (confirm(msg)) {
            $.post("/BSJX/organization/delete", {"fid": fid}, function (data) {
                if (data == "ok") {
...
<body>
<form action="/BSJX/organization/auto-list" method="post" id="forms">
	<div class="search">
		<h3>领料单位信息</h3>
		<table class="searchTab" border="0">
			<tr>
				<td width="10%" align="right">领料单位:</td>
				<td width="20%"><input id="fnumber" name="fnumber" class="inputText" type="text" name=""></td>
	...
	<div class="MainTable marginTop10">
		<div class="MainTableTitle">领料单位列表</div>
		<div class="MainTableInput">
			<a href="/BSJX/organization/add"><img src="../img/add.png" width="27" /><span>新增</span></a>
		</div>
		<table class="tableIn" width="100%" border="0" cellspacing="0" cellpadding="0">
			<thead>
			  <tr class="tableTitleName">
				<td width="20%" align="center">单位代码</td>
				<td width="30%">单位名称</td>
				<td width="30%" align="center">收货库位（地址）</td>
				<td>操作</td>
			  </tr>
		  </thead>
		  <tbody>
		  <c:forEach items="${organizationlist}" var="organization">
			  <tr>
				<td align="center">${organization.organizationnumber}</td>
				<td>${organization.organizationname}</td>
				<td>${organization.organizationaddress}</td>
				<td>
					<a href="/BSJX/organization/detail?organizationnumber=${organization.organizationnumber}">
						<img src="../img/changePen.png" width="20" align="absmiddle" />修改</a>
					<a href="javascript:void(0)" class="xiu"
					   onclick="showMsg('是否删除该项数据？',${organization.fid })">
