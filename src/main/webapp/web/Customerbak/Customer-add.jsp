...
<body>
<form action="/BSJX/custom/create" method="post" id="sub">
	<div class="search">
		<h3>添加客户资料</h3>
		<table class="searchTab" border="0">
			<tr>
				<td width="15%" align="right">客户代号:</td>
				<td><input class="inputText" type="text" name="customnumber"id="customnumber" value=""></td>
				<td width="15%" align="right">客户名称:</td>
				<td><input class="inputText" type="text" name="customname"id="customname" value=""></td>
			</tr>
			<tr>
