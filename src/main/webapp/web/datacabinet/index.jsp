...
<%--	<script type="text/javascript">
	 ...
	 $(document).ready(function() {
		 ...
		 showCondition("datacabinet",'${datacabinetList }'); 
	 });
	</script>--%>
...
<%--   <jsp:include page="condition.jsp"></jsp:include>--%>
  ...
  &nbsp;资料柜列信息管理
   ...
   <div class="row">
       <div class="col-md-9 col-sm-9 col-xs-9">
           <form class="form-inline" action="datacabinet/getList">
               <div class="form-group">
                   <label for="fnumber">资料柜列编码</label>
                   <input type="text" class="form-control" id="fnumber" name="fnumber" placeholder="" value=${model.fnumber }>
               </div>
               <div class="form-group">
                   <label for="fname">资料柜列名称</label>
       ...
       <div class="col-md-3 col-sm-3 col-xs-3" >
            ...
            <div class="buttongroups"> <a class="btn btn-warning btn-sm"  href="javascript:;" onclick="scPrint('datacabinet')">
                <span class="glyphicon glyphicon-qrcode" aria-hidden="true"></span>
                打印</a>
            </div>


           <div class="buttongroups"> <a class="btn btn-danger btn-sm"  href="javascript:;" onclick="DeleteBatch('datacabinet')">
               <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
               删除</a>
           </div>
           <div class="buttongroups" >  <a class="btn btn-primary btn-sm"  href="datacabinet/create">
  ...
  <c:forEach items="${datacabinetList }" var="map">
  <tr>
  <td>
  ...
  <td>${map.fremark }</td>
  <td>
   <button class="btn btn-success btn-xs" onclick="Edit('datacabinet',${map.fid})">
          <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 编辑</button>
      <button class="btn btn-danger btn-xs" id="delete" onclick="Delete('datacabinet',${map.fid})">
