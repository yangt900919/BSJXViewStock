...
<script type="text/javascript">
	$(document).ready(function() {
		showCondition("datainventory", '${datainventorylist }');
		/*if ('<%--${datainventorylist }--%>'.length == 0) {
            initStartDate("sdate");
            initDate("edate");
		}*/
...
<body>
	...
	<div class=container-fluid>
		<div class=title_index>&nbsp;资料库存信息管理</div>
		<div class="row">


					<div class="col-md-10 col-sm-10 col-xs-10">
						<form class="form-inline" action="datainventory/getList">
			...
			<button type="submit" class="btn btn-primary btn-sm ">
				...
				<%--		<div class="buttongroups" >
							<a class="btn btn-success btn-sm" onclick="location.href='datainventory/getExportList'"
...
--%>
						<div class="buttongroups" >
						<a class="btn btn-info btn-sm" onclick="filter('datainventory')"
							href="javascript:;"> <span
		...
		<table class="table table-bordered table-hover table-striped ">
			...
			<tbody>
				<c:forEach items="${datainventorylist }" var="map">
					<tr>
						...
						<%--<td>&lt;%&ndash;<c:if test="${datainventory_edit=='datainventory_edit' }">&ndash;%&gt;
