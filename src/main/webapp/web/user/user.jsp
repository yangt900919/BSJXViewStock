...
<script type="text/javascript">
    function showMsg(msg, fid) {
        ...
        //alert(msg);
        if (confirm(msg)) {
            $.post("/BSJX/user/delete", {"fid": fid}, function (data) {
                if (data == "ok") {
...
<body>
<form action="/BSJX/user/auto-list" method="post" id="forms">
	<div class="search">
		<h3>用户信息</h3>
		<table class="searchTab" border="0">
			<tr>
				<td width="10%" align="right">供应用户:</td>
	...
	<div class="MainTable marginTop10">
		<div class="MainTableTitle">用户列表</div>
		<div class="MainTableInput">
			<a href="/BSJX/user/add"><img src="../img/add.png" width="27" /><span>新增</span></a>
		</div>
		<table class="tableIn" width="100%" border="0" cellspacing="0" cellpadding="0">
			<thead>
			  <tr class="tableTitleName">
				<td width="38%" align="center">用户代码</td>
				<td width="38%">用户名称</td>
				<td>操作</td>
			  </tr>
		  </thead>
		  ...
		  <c:forEach items="${userlist}" var="user">
			  <tr>
				<td align="center">${user.fid}</td>
				<td>${user.username}</td>
				<td>
					<a href="/BSJX/user/detail?fid=${user.fid}">
						<img src="../img/changePen.png" width="20" align="absmiddle" />修改</a>
					<a href="javascript:void(0)" class="xiu"
					   onclick="showMsg('是否删除该项数据？',${user.fid})">
