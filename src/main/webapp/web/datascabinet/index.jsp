...
<html>
  <head>
    ...
    <script type="text/javascript">
     ...
     $("#link", parent.document).text("储柜信息管理");
	</script>
  </head>
...
<%--  <jsp:include page="condition.jsp"></jsp:include>--%>
  ...
  &nbsp;资料柜信息管理
   ...
   <div class="row">
       <div class="col-md-9 col-sm-9 col-xs-9">
           <form class="form-inline" action="datascabinet/getList">
           ...
           <button class="btn btn-primary btn-sm" type="button" onclick="showBasics('datacabinet','fcabinetid','cabinet')">&nbsp;<span class="glyphicon glyphicon-search form-control-feedback" aria-hidden="true" ></span>&nbsp;</button>
               ...
               <div class="form-group">
                   ...
                   <div class="input-group">
                       <input $ type="text" readonly onfocus="clearBasics('fcabinettypeid')"  class="form-control" id="cabinettype" name="cabinettypename"  placeholder="" value=${model.cabinettype.fname}>
       ...
       <div class="col-md-3 col-sm-3 col-xs-3" >
            ...
            <div class="buttongroups"> <a class="btn btn-warning btn-sm"  href="javascript:;" onclick="scPrint('scabinet')">
                <span class="glyphicon glyphicon-qrcode" aria-hidden="true"></span>
                打印</a>
            </div>

           <div class="buttongroups"> <a class="btn btn-danger btn-sm"  href="javascript:;" onclick="DeleteBatch('scabinet')">
               <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
               删除</a>
           </div>
            <div class="buttongroups" >  <a class="btn btn-primary btn-sm"  href="datascabinet/create">
 ...
 <%-- <c:if test="${scabinet_edit=='scabinet_edit' }">--%>
   <button class="btn btn-success btn-xs" onclick="Edit('datascabinet',${map.fid})">
         <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>编辑</button>
       <%--  </c:if>
         <c:if test="${scabinet_delete=='scabinet_delete' }">--%>
      <button class="btn btn-danger btn-xs" id="delete" onclick="Delete('datascabinet',${map.fid})">
