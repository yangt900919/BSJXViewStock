...
<script type="text/javascript">
    function showMsg(msg, fid) {
        ...
        //alert(msg);
        if (confirm(msg)) {
            $.post("/BSJX/stock/delete", {"fid": fid}, function (data) {
                if (data == "ok") {
...
<body>
<form action="/BSJX/stock/auto-list" method="post" id="forms">
	<div class="search">
		<h3>仓库</h3>
		<table class="searchTab" border="0">
			<tr>
				<td width="10%" align="right">供应仓库:</td>
	...
	<div class="MainTable marginTop10">
		...
		<div class="MainTableInput">
			<a href="/BSJX/stock/add"><img src="../img/add.png" width="27" /><span>新增</span></a>
		</div>
		<table class="tableIn" width="100%" border="0" cellspacing="0" cellpadding="0">
			<thead>
			  <tr class="tableTitleName">
				<td width="20%" align="center">仓库代码</td>
				<td width="20%">仓库名称</td>
				<td width="20%" align="center">仓库地址</td>
				<td width="20%">电话</td>
				<td>操作</td>
			  </tr>
		  </thead>
		  ...
		  <c:forEach items="${stocklist}" var="stock">
			  <tr>
				<td align="center">${stock.stocknumber}</td>
				<td>${stock.stockname}</td>
				<td align="center">${stock.stockaddress}</td>
				<td>${stock.stocktel}</td>
				<td>
					<a href="/BSJX/stock/detail?stocknumber=${stock.stocknumber}">
						<img src="../img/changePen.png" width="20" align="absmiddle" />修改</a>
					<a href="javascript:void(0)" class="xiu"
					   onclick="showMsg('是否删除该项数据？',${stock.fid })">
