        ...
        switch (cell.getCellType()) {
            ...
            case Cell.CELL_TYPE_NUMERIC:
                if("General".equals(cell.getCellStyle().getDataFormatString())){
                    {
                        //System.out.println(String.valueOf(cell.getNumericCellValue()).indexOf("E"));
                       if(String.valueOf(cell.getNumericCellValue()).indexOf(".")>0&&String.valueOf(cell.getNumericCellValue()).indexOf("E")<0)
                       {
